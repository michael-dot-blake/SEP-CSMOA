...
public class JobFactory {
	...
	public ArrayList<String> jobPool= new ArrayList<String>();
	public ArrayList <String>gstPool=new ArrayList<String>();
...
//	public void initJobs(String filename) {
...
//					jobPool.add(new Job(jobId, jobType, jobDescription, jobIssueCode, jobIssueDescrp, jobActType, jobActDescrp, jobDate, jobTime, jobPriority, jobSuburb, jobStreet, jobHouseNum, houseNum2String, jobPostCode, jobFitterDistrict, jobDuration));
//					jobAdded = true;
//				}
//				catch (Exception e) {
